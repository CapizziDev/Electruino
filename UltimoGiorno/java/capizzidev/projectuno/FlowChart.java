...
public class FlowChart extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Intent Arduinoo=new Intent(FlowChart.this, Arduino.class) ;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        final Intent passaggio=new Intent(getApplicationContext(),Arduino.class);


        if (id == R.id.If) {
            // Handle the if action
            contatore++;
            final LinearLayout FC = (LinearLayout) findViewById(R.id.FC);
